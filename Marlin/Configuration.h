...
#define STRING_CONFIG_H_AUTHOR "BM 28.01.2024" // Who made the changes.
 ...
 * :[-2, -1, 0, 1, 2, 3, 4, 5, 6, 7]
 */
//#define SERIAL_PORT_2 -1 //6 für wifi
...
#define CUSTOM_MACHINE_NAME "i3 Pro C GTR V1.0"
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  #else
     #define DEFAULT_Kp 8.2292
    #define DEFAULT_Ki 0.4719
    #define DEFAULT_Kd 35.8791
  #endif
#else
 ...
 */
  ...
  #define MPC_BLOCK_HEAT_CAPACITY { 13.98f }           // (J/K) Heat block heat capacities.
  #define MPC_SENSOR_RESPONSIVENESS { 0.1077f }         // (K/s per ∆K) Rate of change of sensor temperature from heat block.
  #define MPC_AMBIENT_XFER_COEFF { 0.0695f }           // (W/K) Heat transfer coefficients from heat block to room air with fan off.
  #if ENABLED(MPC_INCLUDE_FAN)
    #define MPC_AMBIENT_XFER_COEFF_FAN255 { 0.0776f }  // (W/K) Heat transfer coefficients from heat block to room air with fan on full.
  #endif
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 85.7966
  #define DEFAULT_bedKi 17.0231
  #define DEFAULT_bedKd 288.2767
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 98.52, 98.52, 790.12, 289.2753 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 23, 5, -1.875 }
...
#define XY_PROBE_FEEDRATE (200*60)//(133*60)

// Feedrate (mm/min) for the first approach when double-probing (MULTIPLE_PROBING == 2)
#define Z_PROBE_FEEDRATE_FAST (50*60)//(4*60)

// Feedrate (mm/min) for the "accurate" probe of each point
#define Z_PROBE_FEEDRATE_SLOW Z_PROBE_FEEDRATE_FAST/2 //(Z_PROBE_FEEDRATE_FAST / 2)
...
#define Z_CLEARANCE_MULTI_PROBE     0.5 // (mm) Z Clearance between multiple probes
...
#define LCD_BED_TRAMMING
  ...
  #define BED_TRAMMING_INSET_LFRB { 23, 3, 0, 0 } // (mm) Left, Front, Right, Back insets
...
#define HOMING_FEEDRATE_MM_M { (50*60), (50*60), (10*60) } //Z: 4*60
...
#define NOZZLE_CLEAN_FEATURE
  ...
  #define NOZZLE_CLEAN_START_POINT { {  125, 225, (Z_MIN_POS + 0) } }
  #define NOZZLE_CLEAN_END_POINT   { { 175, 220, (Z_MIN_POS + 0) } }
