...
#define BLOCK_BUFFER_SIZE 64 // doubled to try avoid LCD hang as said in troubleshooting BM 16012024
#else
...
// Sequenzes Changet to Original Prusa Sequenzes for MK3S Extruder 04.01.2024 BM
...
#define MMU2_LOAD_TO_NOZZLE_SEQUENCE \
  ...
  {                                  \
    17.7F, 198                       \
  } // feed rate = 13.5mm/s - Load fast while not at heatbreak// feed rate = 3.3mm/s  - Load slower once filament reaches heatbreak
...
/*#define MMU2_CAN_LOAD_SEQUENCE        \
  {0.1, MMU2_CAN_LOAD_FEEDRATE},      \
      {55.0, MMU2_CAN_LOAD_FEEDRATE}, \
  {                                   \
    -47.0, MMU2_CAN_LOAD_FEEDRATE     \
  }*/
